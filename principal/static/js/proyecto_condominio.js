function mostrarVistaPrevia() {
    ...
    var titulo = document.getElementById("titulo_condominio").value;
    var fecha = document.getElementById("fecha_condominio").value;
    var texto = document.getElementById("texto_condominio").value;
    var imagen = document.getElementById("imagen_condominio").files[0];
...
function publicarNoticia() {
    ...
    if (confirmacion) {
        ...
        xhr.open('POST', '/admin_agregar_condominio/', true); // Reemplaza '/admin_agregar_noticia/' por la URL correcta
        xhr.onload = function () {
            if (xhr.status === 200) {
                ...
                document.getElementById("titulo_condominio").value = '';
                document.getElementById("fecha_condominio").value = '';
                document.getElementById("texto_condominio").value = '';
                document.getElementById("imagen_condominio").value = '';
                document.getElementById("Servicio").value = '';
                document.getElementById("texto_ciudad").value = '';
                document.getElementById("texto_tipo_servicio").value = '';
                // Redirige a la página de admin_agregar_condominio.html para agregar una nueva noticia
                window.location.href = "/admin_agregar_condominio/";
            } else {
