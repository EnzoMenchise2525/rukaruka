function mostrarVistaPrevia() {
    ...
    var titulo = document.getElementById("titulo_asbesto").value;
    var fecha = document.getElementById("fecha_asbesto").value;
    var texto = document.getElementById("texto_asbesto").value;
    var imagen = document.getElementById("imagen_asbesto").files[0];
...
function publicarNoticia() {
    ...
    if (confirmacion) {
        ...
        xhr.open('POST', '/admin_agregar_asbesto/', true); // Reemplaza '/admin_agregar_noticia/' por la URL correcta
        xhr.onload = function () {
            if (xhr.status === 200) {
                ...
                document.getElementById("titulo_asbesto").value = '';
                document.getElementById("fecha_asbesto").value = '';
                document.getElementById("texto_asbesto").value = '';
                document.getElementById("imagen_asbesto").value = '';
                document.getElementById("Servicio").value = '';
                document.getElementById("texto_ciudad").value = '';
                document.getElementById("texto_tipo_servicio").value = '';
                // Redirige a la página de admin_agregar_asbesto.html para agregar una nueva noticia
                window.location.href = "/admin_agregar_asbesto/";
            } else {
