function mostrarVistaPrevia() {
    ...
    var titulo = document.getElementById("titulo_verdes").value;
    var fecha = document.getElementById("fecha_verdes").value;
    var texto = document.getElementById("texto_verdes").value;
    var imagen = document.getElementById("imagen_verdes").files[0];
...
function publicarNoticia() {
    ...
    if (confirmacion) {
        ...
        xhr.open('POST', '/admin_agregar_verdes/', true); // Reemplaza '/admin_agregar_noticia/' por la URL correcta
        xhr.onload = function () {
            if (xhr.status === 200) {
                ...
                document.getElementById("titulo_verdes").value = '';
                document.getElementById("fecha_verdes").value = '';
                document.getElementById("texto_verdes").value = '';
                document.getElementById("imagen_verdes").value = '';
                ...
                window.location.href = "/admin_agregar_verdes/";
            } else {
