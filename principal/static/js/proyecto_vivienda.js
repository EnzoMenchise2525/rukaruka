function mostrarVistaPrevia() {
    ...
    var titulo = document.getElementById("titulo_vivienda").value;
    var fecha = document.getElementById("fecha_vivienda").value;
    var texto = document.getElementById("texto_vivienda").value;
    var imagen = document.getElementById("imagen_vivienda").files[0];
...
function publicarNoticia() {
    ...
    if (confirmacion) {
        ...
        var imagen = document.getElementById("imagen_energetico").files[0];
        formData.append('imagen', imagen);

        // Realiza una solicitud AJAX para guardar la noticia en el servidor
        var xhr = new XMLHttpRequest();
        xhr.open('POST', '/admin_agregar_vivienda/', true); // Reemplaza '/admin_agregar_noticia/' por la URL correcta
        xhr.onload = function () {
            if (xhr.status === 200) {
                ...
                document.getElementById("titulo_vivienda").value = '';
                document.getElementById("fecha_vivienda").value = '';
                document.getElementById("texto_vivienda").value = '';
                document.getElementById("imagen_vivienda").value = '';
                ...
                window.location.href = "/admin_agregar_vivienda/";
            } else {
