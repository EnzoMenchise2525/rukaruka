function mostrarVistaPrevia() {
    ...
    var titulo = document.getElementById("titulo_comunitaria").value;
    var fecha = document.getElementById("fecha_comunitaria").value;
    var texto = document.getElementById("texto_comunitaria").value;
    var imagen = document.getElementById("imagen_comunitaria").files[0];
...
// Función para publicar la noticia mediante AJAX
function publicarNoticia() {
    ...
    if (confirmacion) {
        ...
        xhr.open('POST', '/admin_agregar_comunitaria/', true); // Reemplaza '/admin_agregar_noticia/' por la URL correcta
        xhr.onload = function () {
            if (xhr.status === 200) {
                ...
                document.getElementById("titulo_comunitaria").value = '';
                document.getElementById("fecha_comunitaria").value = '';
                document.getElementById("texto_comunitaria").value = '';
                document.getElementById("imagen_comunitaria").value = '';
                document.getElementById("Servicio").value = '';
                document.getElementById("texto_ciudad").value = '';
                document.getElementById("texto_tipo_servicio").value = '';
                // Redirige a la página de admin_agregar_comunitaria.html para agregar una nueva noticia
                window.location.href = "/admin_agregar_comunitaria/";
            } else {
