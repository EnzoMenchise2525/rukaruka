function crearNoticia() {
    ...
    var fecha = document.getElementById("fecha_noticia").value; // Nuevo campo de fecha
...
function publicarNoticia() {
    // Llama a la función crearNoticia para crear la noticia con los datos ingresados
    crearNoticia();
    ...
    if (confirmacion) {
        ...
        var titulo = document.getElementById("titulo_noticia").value;
        var fecha = document.getElementById("fecha_noticia").value;
        var texto = document.getElementById("texto_noticia").value;
        var servicio = document.getElementById("Servicio").value;
        var ciudad = document.getElementById("texto_ciudad").value;
        var tipoServicio = document.getElementById("texto_tipo_servicio").value;
        ...
        xhr.open('POST', '/admin_agregar_noticia/', true); // Reemplaza '/admin_agregar_noticia/' por la URL correcta
        xhr.onload = function () {
            if (xhr.status === 200) {
                ...
                document.getElementById("texto_noticia").value = '';
                document.getElementById("imagen_noticia").value = '';
                document.getElementById("Servicio").value = '';
                document.getElementById("texto_ciudad").value = '';
                document.getElementById("texto_tipo_servicio").value = '';
                // Redirige a la página de admin_agregar.html para agregar una nueva noticia
                window.location.href = "/admin_agregar/";
            } else {
