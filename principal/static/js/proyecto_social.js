function mostrarVistaPrevia() {
    ...
    var titulo = document.getElementById("titulo_social").value;
    var fecha = document.getElementById("fecha_social").value;
    var texto = document.getElementById("texto_social").value;
    var imagen = document.getElementById("imagen_social").files[0];
...
function publicarNoticia() {
    ...
    if (confirmacion) {
        ...
        xhr.open('POST', '/admin_agregar_intSocial/', true); // Reemplaza '/admin_agregar_noticia/' por la URL correcta
        xhr.onload = function () {
            if (xhr.status === 200) {
                ...
                document.getElementById("titulo_social").value = '';
                document.getElementById("fecha_social").value = '';
                document.getElementById("texto_social").value = '';
                document.getElementById("imagen_social").value = '';
                ...
                window.location.href = "/admin_agregar_intSocial/";
            } else {
