function mostrarVistaPrevia() {
    ...
    var titulo = document.getElementById("titulo_energetico").value;
    var fecha = document.getElementById("fecha_energetico").value;
    var texto = document.getElementById("texto_energetico").value;
...
function publicarNoticia() {
    ...
    if (confirmacion) {
        ...
        xhr.open('POST', '/admin_agregar_energetico/', true); // Reemplaza '/admin_agregar_noticia/' por la URL correcta
        xhr.onload = function () {
            if (xhr.status === 200) {
                ...
                document.getElementById("titulo_energetico").value = '';
                document.getElementById("fecha_energetico").value = '';
                document.getElementById("texto_energetico").value = '';
                document.getElementById("imagen_energetico").value = '';
                ...
                window.location.href = "/admin_agregar_energetico/";
            } else {
